...
app.get(`/verify-aadhaar/:id`, requireSessionToken, (req, res) => {
    res.render("otpRequest");
});
app.get(`/otp-page/:id`, requireSessionToken, (req, res) => {
    res.render("otpInput");
});
app.get(`/otp-success/:id`, requireSessionToken, (req, res) => {
